...
const params = new URLSearchParams({ single_use_token: credentials.token, model_id: process.env.ELEVENLABS_TTS_MODEL, output_format: 'pcm_24000', language_code: 'en' });
