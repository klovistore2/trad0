...
const en = {
  ...
  homeIntro: "Two phones, two languages. Speak, and the other person hears you in theirs.",
...
const translations: Partial<Record<Language, Partial<Record<StringKey, string>>>> = {
  fr: {
    ...
    homeIntro: "Deux téléphones, deux langues. Vous parlez, l’autre personne vous entend dans la sienne.",
  ...
  th: {
    ...
    homeIntro: "สองเครื่อง สองภาษา คุณพูด อีกฝ่ายได้ยินเป็นภาษาของเขา",
  ...
  es: {
    ...
    homeIntro: "Dos teléfonos, dos idiomas. Hablas y la otra persona te oye en el suyo.",
  ...
  pt: {
    ...
    homeIntro: "Dois telemóveis, duas línguas. Você fala e a outra pessoa ouve na dela.",
  ...
  it: {
    ...
    homeIntro: "Due telefoni, due lingue. Tu parli e l’altra persona ti sente nella sua.",
  ...
  de: {
    ...
    homeIntro: "Zwei Telefone, zwei Sprachen. Du sprichst, die andere Person hört dich in ihrer.",
  ...
  ja: {
    ...
    homeTitle: "ひとつの会話。",
    homeTitleEm: "壁はない。",
    homeIntro: "2台の電話、2つの言語。あなたが話すと、相手は自分の言語で聞きます。",
  ...
  ko: {
    ...
    homeTitle: "하나의 대화.",
    homeTitleEm: "장벽 없이.",
    homeIntro: "휴대폰 두 대, 언어 두 개. 당신이 말하면 상대는 자기 언어로 듣습니다.",
  ...
  zh: {
    ...
    homeTitle: "一场对话。",
    homeTitleEm: "没有隔阂。",
    homeIntro: "两部手机，两种语言。你开口，对方用自己的语言听到。",
    homeStart: "和某人对话 · 邀请",
    homeCreating: "创建中…",
    homeSignIn: "登录以开始对话",
  ...
  vi: {
    ...
    homeIntro: "Hai điện thoại, hai ngôn ngữ. Bạn nói, người kia nghe bằng tiếng của họ.",
  ...
  id: {
    ...
    homeIntro: "Dua ponsel, dua bahasa. Anda bicara, lawan bicara mendengar dalam bahasanya.",
  ...
  ru: {
    ...
    homeIntro: "Два телефона, два языка. Вы говорите — собеседник слышит на своём.",
  ...
  hi: {
    ...
    homeIntro: "दो फ़ोन, दो भाषाएँ। आप बोलिए, दूसरा व्यक्ति अपनी भाषा में सुनेगा।",
