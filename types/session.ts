...
export type SharedSession = { credits?: { sessionUsed: number; balance: number } | null; creditsExhausted?: boolean; id: string; expiresAt: string; floor: number | null; me: Participant; peer: Participant | null; diagnostics?: boolean; models?: { realtime: string; transcription: string; translation: string } };
