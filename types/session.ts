...
export type SharedSession = { credits?: { sessionUsed: number; balance: number } | null; id: string; expiresAt: string; floor: number | null; me: Participant; peer: Participant | null; diagnostics?: boolean; models?: { realtime: string; transcription: string; translation: string } };
